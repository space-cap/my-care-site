...
import { CheckCircle, Clock, DollarSign, Heart, Shield, Star, Users, ChevronDown, HelpCircle } from "lucide-react"
          ...
          <div className="container mx-auto px-4 max-w-3xl">
            ...
            <div className="space-y-4">
              {[
                {
                  q: "간병 경험이 없어도 되나요?",
                  a: "네, 가능합니다. 케어플러스는 초보자도 쉽게 적응할 수 있도록 기초 교육과 실무 가이드를 무료로 제공합니다. 또한 경험이 많은 멘토와 연결하여 초기 적응을 돕습니다."
                },
                {
                  q: "급여 정산은 언제 되나요?",
                  a: "케어 서비스 종료 후 고객 확인이 완료되면, 영업일 기준 익일에 바로 정산됩니다. 투명하고 빠른 정산 시스템으로 안심하고 일하실 수 있습니다."
                },
                {
                  q: "배상책임보험은 정말 무료인가요?",
                  a: "네, 맞습니다. 간병사님이 안심하고 업무에 집중하실 수 있도록, 케어플러스에서 활동하시는 모든 기간 동안 배상책임보험료를 전액 지원합니다."
                },
                {
                  q: "원하는 시간에만 일할 수 있나요?",
                  a: "물론입니다. 하루 2시간 단기 돌봄부터 주 5일 전일제까지, 간병사님의 생활 패턴에 맞춰 자유롭게 일정을 선택하고 조율하실 수 있습니다."
                }
              ].map((item, index) => (
                <ScrollReveal key={index} delay={index * 100}>
                  <details className="group rounded-xl border border-slate-200 bg-slate-50 open:bg-white open:shadow-md transition-all duration-300">
                    ...
                    <div className="border-t border-slate-100 px-6 pb-6 pt-4 text-slate-600 leading-relaxed pl-14">
                      {item.a}
                    </div>
                  </details>
                </ScrollReveal>
